  ...
  return (
    <>
      <button
        ...
        className="rounded border border-line bg-well-850 px-3 py-1.5 text-[12px] font-medium text-ink transition-colors hover:bg-well-800 hover:text-ink-bright focus-visible:outline-2 focus-visible:outline-accent disabled:cursor-not-allowed disabled:opacity-40"
      >
        + New task
      </button>
        ...
        {open && (
          <SheetContent aria-describedby={undefined}>
            <div className="flex flex-col gap-4 p-4">
              <SheetTitle className="text-[15px] font-semibold text-ink-bright">
                New task
              </SheetTitle>
              <TaskForm
                mode="create"
