...
describe("theme resolution (MMR-74)", () => {
  test("storedChoice accepts only the valid values", () => {
  ...
  test("systemTheme reads the OS preference", () => {
    mockOS(true);
  ...
  test("setTheme persists the pick and reflects it on the document", () => {
    setTheme("light");
  ...
  test("apply sets data-theme without persisting", () => {
    apply("dark");
